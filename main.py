...
# Import utilities
from body_sound_detection.utils import pretty_print_analysis, export_json

# Import classification modules
from body_sound_detection.classification import load_heart_model, load_lung_model, load_bowel_model, HeartSoundClassifier, LungSoundClassifier, BowelSoundClassifier

# Import signal processing modules
from body_sound_detection.signal_processing import HeartbeatAnalyzer, LungSoundAnalyzer, BowelSoundAnalyzer

# Import report generators
from body_sound_detection.report_generator.report_generator import (
...
# Agent imports
try:
    from body_sound_detection.agent.agent import build_heartbeat_agent, build_bowel_agent, build_lung_agent
except ImportError:
...
def run_bowel_signal_processing(uploaded_file, results_dict):
    ...
    from body_sound_detection.signal_processing.visualizer import plot_results
    plot_results(
        time=data["time"],
        raw=data["raw"],
